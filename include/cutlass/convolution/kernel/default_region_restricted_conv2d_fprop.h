...
#include "cutlass/convolution/kernel/implicit_batched_gemm_region_restricted_dwconv2d_fprop.h"
...
struct DefaultRegionRestrictedConvolution2dFprop;
...
struct DefaultRegionRestrictedConvolution2dFprop<
    ...
    using MmaCore = typename cutlass::conv::threadblock::
            DefaultRegionRestrictedFpropMmaCore<
    ...
    using MmaPipelineSingleStage = cutlass::conv::threadblock::
            RegionRestrictedFpropMmaNtPrecompSingleStage<
                    ...
                    typename MmaCore::SmemIteratorMaskOutput, ElementMaskOutput,
                    LayoutMaskOutput, ElementAccumulator, LayoutDst,
